defmodule EasyWeb.EmployeeControllerTest do
  use EasyWeb.ConnCase

  alias Easy.Accounts

  @create_attrs %{email: "some email", first_name: "some first_name", last_name: "some last_name", mobile: "some mobile"}
